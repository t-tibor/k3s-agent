...
// (docs/ARCHITECTURE.md §3). This also means no browser-side cross-origin call is made to the Agent, so the
// Agent's CORS policy (Agent:AllowedOrigins) is no longer needed for this default frontend — it's kept as a
// still-available option for any other, browser-direct frontend.
